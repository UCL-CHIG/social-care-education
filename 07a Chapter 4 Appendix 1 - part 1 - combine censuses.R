...
# ANCHOR (receptin/year 1) -------------------------------------------------------------------

# * cohort 1 - year 1 (2005/06) ----------------------------------------------------
...
c1y1 <- c1y1[ncyearactual == "1" |
               (ncyearactual == "X" & ageatstartofacademicyear == 5)]

subset_length_c1[1] <- nrow(c1y1)

c1y1 <- c1y1[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
table(c1y1$pupilmatchingrefanonymous %in% c2y0$pupilmatchingrefanonymous) 
table(c2y0$pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous) 

c2y0 <- c2y0[!(pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous)]
...
c1y2 <- c1y2[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
subset_length_c1[2] <- nrow(c1y2)

c1y2 <- c1y2[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
c1y3 <- c1y3[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y3 <- c1y3[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
ap$sourcetable <- "AP"
ap <- ap[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
ap <- ap[!duplicated(pupilmatchingrefanonymous)]
...
c1y3 <- c1y3[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y4 <- c1y4[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y4 <- c1y4[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
c1y4 <- c1y4[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y5 <- c1y5[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y5 <- c1y5[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
pru$censusdate <- as.Date(pru$censusdate, format = "%Y-%m-%d")
pru <- pru[censusdate == as.Date("2010-01-21")]
pru <- pru[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
pru <- pru[!duplicated(pupilmatchingrefanonymous)]
...
c1y5 <- c1y5[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y6 <- c1y6[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y6 <- c1y6[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
c1y6 <- c1y6[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y7 <- c1y7[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y7 <- c1y7[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
c1y7 <- c1y7[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y8 <- c1y8[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y8 <- c1y8[order(pupilmatchingrefanonymous, recordstatus, entrydate, leavingdate)]
...
ap$sourcetable <- "AP"
ap <- ap <- ap[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
ap <- ap[!duplicated(pupilmatchingrefanonymous)]
...
c1y8 <- c1y8[order(pupilmatchingrefanonymous, entrydate, leavingdate)]
...
c1y9 <- c1y9[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y10 <- c1y10[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y10 <- c1y10[order(pupilmatchingrefanonymous)]
...
c1y11 <- c1y11[pupilmatchingrefanonymous %in% c1y1$pupilmatchingrefanonymous]
...
c1y11 <- c1y11[order(pupilmatchingrefanonymous)]
...
write.csv(raw_length_c1, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/raw_length_c1.csv")
write.csv(subset_length_c1, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/subset_length_c1.csv")
write.csv(final_length_c1, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/final_length_c1.csv")

write.csv(raw_length_c2, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/raw_length_c2.csv")
write.csv(subset_length_c2, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/subset_length_c2.csv")
write.csv(final_length_c2, file = "OUTPUTS/CHAPTER 4/cap4_appendix1/final_length_c2.csv")
...
write.csv(aggregate(pupilmatchingrefanonymous ~ year, data = cohort1, function(x) length(unique(x))),
          file = "OUTPUTS/CHAPTER 4/cap4_appendix1/unique_children_c1.csv")
...
write.csv(aggregate(pupilmatchingrefanonymous ~ year, data = cohort2, function(x) length(unique(x))),
          file = "OUTPUTS/CHAPTER 4/cap4_appendix1/unique_children_c2.csv")
...
save(cohort1, file = "PROCESSED DATA/cap4_appendix1/cohort1.rda")
save(cohort2, file = "PROCESSED DATA/cap4_appendix1/cohort2.rda")
rm(list = ls()); gc()
